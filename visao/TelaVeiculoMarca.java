 ...
 * @author Aluno
 */
public class TelaVeiculoMarca extends javax.swing.JFrame {

    /**
     * Creates new form TelaVeiculoMarca
     */
    public TelaVeiculoMarca() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Colocar as logo depois", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVeiculoMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVeiculoMarca().setVisible(true);
            }
        });
    }
